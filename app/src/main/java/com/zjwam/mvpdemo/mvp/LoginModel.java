...
public class LoginModel implements ILoginModel {
    public void getData(String url, Object context, Map<String, String> param, final CallBack callBack) {
    ...
    public interface CallBack {
        void onSuccess(Response<ResponseBean<EmptyBean>> response);
        void onError(Response<ResponseBean<EmptyBean>> response);
        void onFinish();
    }
